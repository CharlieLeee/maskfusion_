...
class GPUConfig {
 ...
 private:
  GPUConfig()
    ...
    icpStepMap["GeForce RTX 2060"] = std::pair<int, int>(512, 32);
    rgbStepMap["GeForce RTX 2060"] = std::pair<int, int>(160, 64);
    rgbResMap["GeForce RTX 2060"] = std::pair<int, int>(128, 512);
    so3StepMap["GeForce RTX 2060"] = std::pair<int, int>(240, 48);
